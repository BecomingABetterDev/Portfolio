...
export const SKILLS = [
  {
    category: 'Frontend',
    items: ['React 18', 'Tailwind CSS', 'Vite', 'Vanilla JS (ES6+)', 'HTML5/CSS3', 'Service Workers', 'IndexedDB'],
  },
  {
    category: 'Backend',
    items: ['Node.js', 'Express.js', 'MongoDB', 'Mongoose ODM', 'JWT Auth', 'REST API Design'],
  },
  {
  ...
  {
    category: 'Concepts',
    items: ['Offline-First Architecture', 'Client-Side Algorithm Design', 'Multi-User Auth Systems', 'Browser Storage APIs'],
  },
]
...
export const STATIC_PROJECTS = [
  {
    ...
    status: 'Active',
    shortDescription:
      'Solves digital learning disruption for students in low-connectivity environments. Tasks, notes, and Pomodoro sessions persist through full internet outages and auto-sync on reconnect.',
    fullDescription:
      'Solves severe digital learning disruption for students in low-connectivity environments. Students can create tasks, study notes, and Pomodoro sessions that continue working during full internet outages, syncing to the cloud the moment connectivity returns.',
    techStackTags: ['Node.js', 'Express.js', 'MongoDB', 'Vanilla JS', 'Service Workers', 'IndexedDB', 'LocalStorage', 'JWT'],
  ...
  },
  {
    ...
    status: 'Completed',
    shortDescription:
      'Crisis response triage tool that runs entirely in the browser. A custom sorting algorithm evaluates patient metrics and outputs a ranked priority list — zero server round-trips.',
    fullDescription:
      'Built for crisis response workflows where servers are overloaded or unreachable. Operators input available medical resource pools and patient data — a custom sorting algorithm runs entirely in the browser, producing a ranked priority triage list in real time with zero server round-trips.',
  ...
  },
  {
    ...
    status: 'Completed',
    shortDescription:
      'Multi-user financial tracking with JWT-isolated ledgers, real-time P&L analysis, and dynamic conditional table styling based on profit/loss state.',
    fullDescription:
      'Multi-user financial tracking platform with secure JWT-based authentication, ledger monitoring, and real-time profit/loss analysis. Each user\'s financial records are fully isolated via Express middleware auth layers.',
    techStackTags: ['Node.js', 'Express.js', 'MongoDB', 'JWT Auth', 'React', 'Recharts'],
    architectureHighlights: [
